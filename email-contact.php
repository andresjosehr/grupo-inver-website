													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" width="144" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<div class="img-center" style="font-size:0pt; line-height:0pt; text-align:center;"><a href="#" target="_blank"><img style="height: 100%" src="images/grupo_inver2.png" border="0" width="144" height="18" alt="" /></a></div>
															</th>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-nav righten m-center" style="color:#1d2025; font-family:'Barlow Condensed', Arial,sans-serif; font-size:16px; line-height:26px; text-align:right;">
																			<a href="#" target="_blank" class="link-4" style="color:#1d2025; text-decoration:none;">Todos los derechos reservados</a>
																		</td>
																	</tr>
																</table>
															</th>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td class="p-25-15" style="padding: 30px 30px 50px 30px;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-4-white centered" style="padding-bottom: 30px; color:#ffffff; font-family:'Quicksand', Arial,sans-serif; font-size:22px; line-height:34px; text-align:left;">
																			Nombre: {{ nombre }}<br />
																			...
																			Tipo de propiedad: {{ TipoPropiedad }} <br />
																			Dormitorios: {{ dormitorios }} <br />
																			Numero de Baños: {{ banos }} <br />
																			Superficie total: {{ superficie }} <br />
																			Barrio: {{ barrio }} <br />
																			Precio: {{ importe }} <br />
																			Horario de visita: {{ horario }} <br />
																			Descripcion: {{ descripcion_propiedad }} <br />
																			Operacion: {{ VenderAlquilarPropiedad }}
																		</td>
																	</tr>
																	<tr>
																		<td align="center">
